...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            return Emps.Where(a => a.Salary == Emps.Select(a => a.Salary).Max());
        }
        ...
        {            
            return Emps.GroupBy(a => a.Job).Select(g => new{
                Praca = g.Key,
        ...
        {
            return Emps.Where(a => a.Job == "Backend programmer").Count() > 1;
        }
        ...
        {
            return Emps.Where(a => a.Job == "Frontend programmer")
        ...
        {
            return arr.ToList().GroupBy(a => a.GetHashCode())
            .Select(a => new{
                number = a.Key,
                count = a.Count()
            }).Where(a => a.count%2 != 0)
        ...
        {
            return Depts.GroupJoin(Emps, dept => dept.Deptno, emp => emp.Deptno, (dept, emp) => new{
                dept = dept,
                count = emp.Count()
            }).Where(a => a.count == 0 || a.count == 5)
            .Select(a => a.dept);
        }
    }
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            return emps.Where(a => emps.Any(q => q.Mgr == a.Mgr))
            .OrderBy(a => a.Ename)
